        ...
        <template #header>
            ...
            >
                <div class="flex flex-col gap-1">
                    <h2 class="font-semibold text-xl leading flex items-center gap-3">
                    ...
                    <div class="flex flex-wrap gap-4 items-center">
                        ...
                        >
                            ...
                            <span class="font-semibold">Team</span> {{ website.team.name }}
                        </a>
                        <a
                            class="flex gap-1 items-center"
                            :href="`//${website.domain}`"
                        ...
                        >
                            ...
                            <span class="font-semibold">Site ID</span> {{ website.id }}
                        </a>
                    </div>
                </div>
                <div class="flex items-center gap-2 md:w-1/2">
                    ...
                    >
                        <template #left-sidebar>
                            <ul class="flex flex-col whitespace-nowrap text-sm">
                                <li
                                    class="hover:bg-gray-700 rounded p-2 text-purple-300 font-semibold"
                                >
                                    Today
                                </li>
        ...
        <div>
            <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8 dark:text-gray-200">
                ...
                <div class="grid grid-cols-1 gap-4 mb-4">
                    <Card>
                        <VisitsViewsChart :dates="dates" :visitors="stats.visitors" :views="stats.views" />
                    </Card>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <Card>
                        <RefererStats :referers_visitors="stats.referers_visitors" :referers_views="stats.referers_views"/>
                    </Card>
                </div>
